...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { input_name: @input.input_name, input_type: @input.input_type, transformation: @input.transformation } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { input_name: @input.input_name, input_type: @input.input_type, transformation: @input.transformation } }
